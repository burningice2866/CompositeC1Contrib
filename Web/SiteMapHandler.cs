    ...
    public class SiteMapHandler : IHttpHandler
    {
        ...
        void IHttpHandler.ProcessRequest(HttpContext ctx)
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                _writer.WriteComment("Generated by DOT GL to comply with Sitemaps protocol");
            ...
            if (baseNode != null)
            {
                ...
                if (priority.HasValue)
                {
                    if (priority > 1 && priority < 10)
                    {
                        ...
                        _writer.WriteString((priority.Value / 10).ToString("0.0", CultureInfo.InvariantCulture));
                        _writer.WriteEndElement();
                    }
                }
            }
